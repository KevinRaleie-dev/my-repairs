...
const Verification = () => {
	...
	const { data: me, isLoading, error } = useQuery('me-query', meQuery)
	...
	return (
		<div>
			...
			<Head>
				<title>MyRepairs | Verify Your Phone Number</title>
			</Head>
			<Logo />
			<Container
				h='100vh'
			...
			>
				...
				{
					me?.response?.data === undefined ? (
						<>
							<Stack align="center">
								<Text textAlign="center">Something went wrong, it could be us or your network. Please try again later.</Text>
								<Text 
								onClick={() =>  router.back()}
